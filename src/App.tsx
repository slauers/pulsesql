...
function App() {
  return (
    <div className="h-screen w-screen bg-background text-text overflow-hidden flex flex-col relative">
      ...
      <div className="h-14 border-b border-border/80 glass-panel flex items-center justify-between px-4 shrink-0 relative z-10">
